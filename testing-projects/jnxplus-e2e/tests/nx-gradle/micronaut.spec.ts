...
describe('nx-gradle micronaut e2e', () => {
  ...
  it('should create a micronaut java application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:application ${appName} --directory ""  --framework micronaut`,
    );
  ...
  it('should create a kotlin application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:application ${appName} --directory ""  --framework micronaut --language kotlin --port ${port}`,
    );
  ...
  xit('should build-image of a kotlin application', async () => {
    if (!isWin && !isMacOs && isCI) {
      const appName = uniq('g-m-app-');
      await runNxCommandAsync(
        `generate @jnxplus/nx-gradle:application ${appName} --directory ""  --framework micronaut --language kotlin`,
      );
      const buildImageResult = await runNxCommandAsync(
        `build-image ${appName}`,
      );
  ...
  it('should create a library', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:library ${libName} --directory ""  --framework micronaut`,
    );
  ...
  it('should create a kotlin library', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:library ${libName} --directory ""  --framework micronaut --language kotlin`,
    );
  ...
  it('should add a lib to an app dependencies', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:library ${libName} --directory ""  --framework micronaut --projects ${appName}`,
    );
  ...
  it('should add a kotlin lib to a kotlin app dependencies', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:application ${appName} --directory ""  --framework micronaut --language kotlin --packaging war`,
    );

    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:library ${libName} --directory ""  --framework micronaut --language kotlin --projects ${appName}`,
    );
  ...
  it('should create a minimal java application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:application ${appName} --directory ""  --framework micronaut --minimal --port ${port}`,
    );
  ...
  it('should create a minimal kotlin application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:application ${appName} --directory ""  --framework micronaut --language kotlin --minimal --port ${port}`,
    );
  ...
  it('should skip starter code when generating a java library with skipStarterCode option', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:library ${libName} --directory ""  --framework micronaut --skipStarterCode`,
    );
  ...
  it('should skip starter code when generating a kotlin library with skipStarterCode option', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-gradle:library ${libName} --directory ""  --framework micronaut --language kotlin --skipStarterCode`,
    );
