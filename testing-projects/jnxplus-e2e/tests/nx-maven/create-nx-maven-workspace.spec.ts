...
describe('nx-maven create-nx-maven-workspace', () => {
  ...
  it('should be installed', () => {
    workspaceDirectory = createTestWorkspaceWithCustomCli(
      ...
      '--javaVersion 17 --dependencyManagement spring-boot-parent-pom --aggregatorProjectGroupId com.example --aggregatorProjectName root-project --aggregatorProjectVersion 0.0.0 --mavenRootDirectory nx-maven',
    );
